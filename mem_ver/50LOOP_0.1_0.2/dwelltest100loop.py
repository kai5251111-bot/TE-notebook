...
def run_internal_staircase(addr="GPIB0::22::INSTR", start_v=1, stop_v=125, step=1, dwell_s=0.01, nplc=0.2,fscan=0):
...
def repeat_tests_and_save_multiple_csv():
    ...
    for run_idx in range(50):  # 每個 dwell_s 做 10 組測試
        ...
        filename = f"dwell_{dwell:.2f}_0{run_idx}_NPLC0.2.csv"
